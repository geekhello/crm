...
<script type="text/javascript">
	/* $(function(){
		$.post("${pageContext.request.contextPath}/linkman/findAllCustomer.action",function(data){
			$("#custId").append("<option>-请选择-</option>");
			$.each(data,function(i,n){
				$("#custId").append("<option value="+n.custId+">"+n.custName+"</option>")
			});
		},"json");
	}); */
</script>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>联系人性别：</td>
								<td>
									<input type="radio" value="1" name="linkMan.lkmGender">男
									<input type="radio" value="2" name="linkMan.lkmGender">女
								</td>
							</TR>
							<TR>
								<td>联系人办公电话 ：</td>
							...
							<TR>
								...
								<td>联系人职位 ：</td>
								<td>
									<INPUT class=textbox id=sChannel2 style="WIDTH: 180px" maxLength=50 name="linkMan.lkmPosition">
								</td>
							</TR>
							<TR>
								<td>联系人简介 ：</td>
