...
<BODY>
	<FORM id="customerForm" name="customerForm" action="${pageContext.request.contextPath }/linkman/listLinkManByName.action" method=post>		
										...
										<TABLE id=grid style="BORDER-TOP-WIDTH: 0px; FONT-WEIGHT: normal; BORDER-LEFT-WIDTH: 0px; BORDER-LEFT-COLOR: #cccccc; BORDER-BOTTOM-WIDTH: 0px; BORDER-BOTTOM-COLOR: #cccccc; WIDTH: 100%; BORDER-TOP-COLOR: #cccccc; FONT-STYLE: normal; BACKGROUND-COLOR: #cccccc; BORDER-RIGHT-WIDTH: 0px; TEXT-DECORATION: none; BORDER-RIGHT-COLOR: #cccccc" cellSpacing=1 cellPadding=2 rules=all border=0>
											<TBODY>
												...
												<TR
													...
													<c:if test="${authority==3 or authority==2 }">
														<TD>
														<a href="${pageContext.request.contextPath }/linkman/editLinkManUI.action?lkmId=${linkman.lkmId}">修改</a>
														&nbsp;&nbsp;
														<a href="${pageContext.request.contextPath }/linkman/deleteLinkMan.action?lkmId=${linkman.lkmId}">删除</a>
														</TD>
													</c:if>
												</TR>
												</c:forEach>
