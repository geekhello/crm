...
<BODY>
	<FORM id="customerForm" name="customerForm" action="${pageContext.request.contextPath }/customer/listCustomerByName.action" method=post>	
										...
										<TABLE id=grid style="BORDER-TOP-WIDTH: 0px; FONT-WEIGHT: normal; BORDER-LEFT-WIDTH: 0px; BORDER-LEFT-COLOR: #cccccc; BORDER-BOTTOM-WIDTH: 0px; BORDER-BOTTOM-COLOR: #cccccc; WIDTH: 100%; BORDER-TOP-COLOR: #cccccc; FONT-STYLE: normal; BACKGROUND-COLOR: #cccccc; BORDER-RIGHT-WIDTH: 0px; TEXT-DECORATION: none; BORDER-RIGHT-COLOR: #cccccc" cellSpacing=1 cellPadding=2 rules=all border=0>
											<TBODY>
												...
												<TR style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
													...
													<TD>${customer.baseDict.dictItemName }</TD>
													...
													<TD>${customer.custCorporation}</TD>
													<TD>${customer.custMemo}</TD>
													<c:if test="${authority==2 or authority==3 }">
														<TD>
														<a href="${pageContext.request.contextPath }/customer/editCustomerUI.action?custId=${customer.custId}">修改</a>
														&nbsp;&nbsp;
														<a href="${pageContext.request.contextPath }/customer/removeCustomer.action?custId=${customer.custId}">删除</a>
														</TD>
													</c:if>
												</TR>	
												</c:forEach>
